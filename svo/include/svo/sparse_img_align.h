...
class SparseImgAlign : public vk::NLLSSolver<6, SE3>
{
  ...
  static const int patch_size_ = 2*patch_halfsize_;        // 4
  static const int patch_area_ = patch_size_*patch_size_;  // 16
public:
...
protected:
  ...
  // cache:
  Matrix<double, 6, Dynamic, ColMajor> jacobian_cache_;  // 动态列，存储方式列优先
